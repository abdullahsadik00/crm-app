    ...
    <div>
      ...
      <div className="container">
        ...
        <div className="mb-3">
          ...
          >
            {users.map((u) => (
              <option selected={u.name === ticket.assignedTo} value={u.name}>
                {u.name}
              </option>
            ))}
          </select>
        ...
        <div className="mb-3">
          ...
          >
            ...
            <option selected={"New" === ticket.status} value="New">
              New
            </option>
            <option selected={"Assigned" === ticket.status} value="Assigned">
              Assigned
            </option>
            <option
              selected={"In Progress" === ticket.status}
              value="In Progress"
            >
              In Progress
            </option>
            <option selected={"Resolved" === ticket.status} value="Resolved">
              Resolved
            </option>
          </select>
        </div>
        ...
        >
          {desc && <span>Update Ticket</span>}
          {!desc && <span>Create Ticket</span>}
        </button>
      </div>
    </div>
  );
